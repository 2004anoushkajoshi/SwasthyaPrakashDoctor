...
export default function DoctorScreen() {
  ...
  // New state for translation actions
  ...
  const translateText = async (targetLang = selectedTargetLanguage) => {
    ...
    try {
      // Prepare text for translation - separate sections for better translation quality
      const sections = {
      ...
      // Translate each section individually for better accuracy
        ...
        <div className="translation-config">
          ...
          <div className="translation-buttons">
            <button 
              ...
              disabled={translating || (!diagnosis && !nutrition && !notes && !medicines)}
